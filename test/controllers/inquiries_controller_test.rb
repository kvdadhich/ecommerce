...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { description: @inquiry.description, email: @inquiry.email, name: @inquiry.name, quantity: @inquiry.quantity }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { description: @inquiry.description, email: @inquiry.email, name: @inquiry.name, quantity: @inquiry.quantity }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
